...
parse_token_examples.each do |eg|
  describe "#parse_token" do
    it eg.inspect do
      assert_equal eg[:expect], Calc.parse_token(eg[:given])
    end
  end
end
...
tokenize_step_examples.each do |eg|
  describe "#tokenize_step" do
    it eg.inspect do
      assert_equal eg[:expect], Calc.tokenize_step(*eg[:given])
    end
  end
end
...
tokenize_examples.each do |eg|
  describe "#tokenize" do
    it eg.inspect do
      assert_equal eg[:expect], Calc.tokenize(eg[:given])
    end
  end
end
...
calculate_examples.each do |eg|
  describe "#calculate" do
    it eg.inspect do
      assert_equal eg[:expect], Calc.calculate(eg[:given])
    end
  end
end
...
calculate_step_examples.each do |eg|
  describe "#calculate_step" do
    it eg.inspect do
      assert_equal eg[:expect], Calc.calculate_step(*eg[:given])
    end
  end
end
